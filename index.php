 ...
 <body>
  ...
  <div class="container">
   <div class="row justify-content-center">
    <div class="col-md-8">
     <form class="" action="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/lotus/api/process.php?action=save'; ?>" method="POST" enctype="multipart/form-data">
      <div class="row">
       <div class="col">
      ...
      <div class="form-label-group mt-2 mb-4">
       ...
       <label for="investment_val">Investment value (10 unit minimum) - Please click to change</label>
      </div>
